...
public class TestComposite {
	public static void main(String[] args) {
		...
		StructuraOrganizatorica departamentIT = new StructuraOrganizatorica("DepartamentIT",
				"Departamentul care asigura suportul IT");

		// definire nod composite
		StructuraOrganizatorica echipaDezvoltare = new StructuraOrganizatorica("Echipa dezvoltare",
				"Echipa programatori");
