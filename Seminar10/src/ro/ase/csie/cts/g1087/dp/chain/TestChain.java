...
public class TestChain {
	...
	public static void main(String[] args) {
		...
		NodChainAbstract filtruChat = new ModulFiltru("Reguli lima Romana");
		
		//ca sa existe chain trebuie sa le inlantuim 
		...
		serverChat.procesareMesajChat(new MesajChat("@Gigel", "Hai sa incercam nivelul 5",1));//nu afiseaza asta
	}
